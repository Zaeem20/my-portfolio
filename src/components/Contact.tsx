...
const TryHackMeLogo = ({ size = 18 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/Zaeem20", icon: GithubLogo, handle: "@Zaeem20", color: "#f0f6fc" },
  { label: "LinkedIn", href: "https://linkedin.com/in/zaeem-durani", icon: LinkedinLogo, handle: "zaeem-durani", color: "#0a66c2" },
  { label: "X", href: "https://x.com/TechnicalZaeem", icon: XLogo, handle: "@TechnicalZaeem", color: "#ffffff" },
  { label: "TryHackMe", href: "https://tryhackme.com/p/Zaeem20", icon: TryHackMeLogo, handle: "Zaeem20", color: "#ffffff" },
  { label: "Instagram", href: "https://instagram.com/zaeem.technical", icon: InstagramLogo, handle: "@zaeem.technical", color: "#e4405f" },
  { label: "Discord", href: "https://discord.gg/RckwnfQfTT", icon: DiscordLogo, handle: "Join Server", color: "#5865f2" },
];
...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-32 md:py-40 relative">
      <div className="max-w-[1400px] mx-auto px-6">
        {/* CTA Block */}
        <div className="contact-cta max-w-4xl mx-auto text-center mb-20 md:mb-28">
          <h2 className="font-display text-5xl md:text-7xl lg:text-8xl font-semibold text-text-primary leading-[0.9] tracking-tight mb-8">
            Let&apos;s build
            <br />
          ...
          <p className="text-text-secondary text-lg md:text-xl max-w-xl mx-auto mb-10 leading-relaxed">
            Have a project, security audit or research idea? I am open to conversations at the intersection of engineering and security.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <MagneticButton>
              <a
                ...
                className="group inline-flex items-center gap-3 pl-8 pr-2 py-2 bg-text-primary text-void rounded-full font-medium transition-all duration-500 hover:bg-white active:scale-[0.98]"
              >
            ...
            <a
              href="mailto:duranizaeem@gmail.com"
              className="text-sm text-text-tertiary hover:text-text-primary transition-colors duration-300 font-mono"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
          {socialLinks.map((social) => {
            ...
            return (
              ...
              >
                <div className="h-full flex items-center gap-4 p-5 rounded-[calc(2rem-2px)] bg-surface border border-hairline transition-all duration-500 hover:border-hairline-strong">
                  <div className="w-10 h-10 rounded-xl bg-void-elevated flex items-center justify-center text-text-tertiary group-hover:text-[var(--hover-color)] transition-colors duration-300">
                    <Icon size={18} weight="duotone" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="font-display font-medium text-text-primary text-sm">
                      {social.label}
                    </div>
                  ...
                  <ArrowUpRight
                    size={14}
                    weight="duotone"
                    className="text-text-tertiary group-hover:text-[var(--hover-color)] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-300"
                  />
                </div>
              </a>
            );
      ...
      {/* Footer */}
      <footer className="max-w-[1400px] mx-auto px-6 mt-24 pt-8 border-t border-hairline">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-text-tertiary font-mono">
            &copy; {new Date().getFullYear()} Zaeem Durani. All rights reserved.
          </p>
          <p className="text-xs text-text-tertiary font-mono">
            Built with Next.js, Tailwind and precision.
          </p>
        </div>
      </footer>
    </section>
